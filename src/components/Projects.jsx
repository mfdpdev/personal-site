    ...
    <>
      <div className="mt-40 text-slate-300 text-center">
        ...
        <div className="mt-8 gap-5 grid grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          <div className="relative -z-1 bottom-0 hover:bottom-2 transition-all duration-300 overflow-hidden bg-slate-800 bg-opacity-80 rounded-xl border border-slate-700">
            <div className="bg-white h-42">
            </div>
