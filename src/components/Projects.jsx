  ...
  return (
    <>
      <div className="mt-72 text-slate-300 overflow-hidden">
        ...
        <div ref={projectsRef} className={`${projectsInView ? "translate-y-0 opacity-100" : "translate-y-1/2 opacity-0"} transform transition duration-[1s] mt-12 gap-8 grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3`}>
