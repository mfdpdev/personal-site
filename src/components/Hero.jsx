    ...
    <>
      <div className="flex flex-wrap mt-6 gap-8">
        <div className="sm:flex-1">
          <div ref={heroRef} className={`${heroInView ? "translate-x-0 opacity-100" : "-translate-x-full opacity-0"} transform transition duration-[1s] space-y-2 text-slate-700 p-6 w-full bg-slate-300 hero-shape`}>
          ...
          <div ref={socialRef} className={`${socialInView ? "translate-x-0 opacity-100" : "-translate-x-full opacity-0"} transform transition duration-[1.2s] text-slate-300 mt-6 w-full`}>
